...
DROP TABLE IF EXISTS requests CASCADE;  -- Проблема: items зависит от requests
DROP TABLE IF EXISTS booking CASCADE;
DROP TABLE IF EXISTS items CASCADE;     -- items удаляется после requests, но должна быть до
